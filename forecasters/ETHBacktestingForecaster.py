...
class ETHBacktestingForecaster:    
    ...
    def train(self, high_values):
        url = 'https://query1.finance.yahoo.com/v7/finance/download/ETH-USD?period1=1410825600&period2=' + BacktestingForecaster.get_yesterday_epoch() + '&interval=1d&events=history&includeAdjustedClose=true'
